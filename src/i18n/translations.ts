export const translations = {
  ru: {
    ...
    errorInvalidVideoType: "Неверный тип видео файла",
    errorInvalidImageType: "Неверный тип изображения",
    errorVideoTooLarge: "Видео слишком большое (максимум 200 МБ)",
    errorImageTooLarge: "Изображение слишком большое (максимум 10 МБ)",
  ...
  en: {
    ...
    errorInvalidVideoType: "Invalid video file type",
    errorInvalidImageType: "Invalid image file type",
    errorVideoTooLarge: "Video is too large (max 200 MB)",
